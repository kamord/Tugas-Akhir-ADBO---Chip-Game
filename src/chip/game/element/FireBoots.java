...
/**
 *  Kelas FireBoots yang mempresentasikan sepatu api agar bisa berjalan diatas 
 *  api.
 * 
...
public class FireBoots {
    /**
     * Atribut position bertipe Point untuk menentukan posisi/letak koordinat FireBoots
     */
     ...
     * @param p posisi dari fire boots bertipe Point
     */
    public FireBoots(Point p)
    {
        this.position = p;
    }
}
