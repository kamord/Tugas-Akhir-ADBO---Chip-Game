...
/**
 *  Kelas IC yang mempresentasikan IC 
 *  
 * @author Albert Kamord,Rommy Kurniawan Wijaya
 */
public class IC {
    /**
     * Atribut position bertipe Point untuk menentukan posisi/letak koordinat IC
     */
     ...
     * @param p posisi dari integrated circuit bertipe Point
     */
    public IC(Point p)
    {
        this.position = p;
